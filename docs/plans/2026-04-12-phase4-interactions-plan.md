...
<action> Update `_layouts/default.html` to include `<script defer src="{{ '{{ site.baseurl }}{{ site.baseurl }}/assets/js/smooth-scroll.js' | prepend: site.baseurl }}"></script>` right before the `</body>` tag.
