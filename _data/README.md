...
| `music.file` | Path to the audio file. | `.{{ site.baseurl }}{{ site.baseurl }}/assets/music/interstellar.mp3` |
| `use_logo_image` | Toggle between text name and image logo in nav. | `true`, `false` |
| `nav_bar_logo_url` | Path to your branded logo. | `.{{ site.baseurl }}{{ site.baseurl }}/assets/img/theprofile.png` |
